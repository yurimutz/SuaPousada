...
public class FuncionarioControllerTest
{
    ...
    void deveRetornarOkAoAtualizarFuncionario() throws Exception
    {
        ...
        FuncionarioUpdateRequestDTO request = new FuncionarioUpdateRequestDTO("yuri doido", "18871809742", LocalDate.of(2002, 1, 1), Genero.MASCULINO, "oi2@gmail.com", "999");

        FuncionarioResponseDTO responseDTO = new FuncionarioResponseDTO(1L, "yuri doido", "18871809742", LocalDate.of(2002, 7, 19), Genero.MASCULINO, "oi2@gmail.com", "990892873");
    ...
    void deveRetornarOkAoProcurarFuncionarioPeloId() throws Exception
    {
        ...
        FuncionarioResponseDTO responseDTO = new FuncionarioResponseDTO(1L, "yuri doido", "19089723", LocalDate.of(2002, 7, 19), Genero.MASCULINO, "oi2@gmail.com", "990892873");
